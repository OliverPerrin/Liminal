...
Behavioral guidelines for coding agents. Use these rules to reduce common LLM coding mistakes.
...
- Preservecomments unless they are clearly outdated and directly affected by the task.
